...
public class AlgaeL2 extends SequentialCommandGroup {
  /** Creates a new AlgaeL2. */
  CoralSubsystem coral;
  ElevatorSubsystem ele;

  public AlgaeL2(CoralSubsystem coral, ElevatorSubsystem ele) {
    // Add your commands in the addCommands() call, e.g.
    // addCommands(new FooCommand(), new BarCommand());
    addCommands(
      new MoveEL5(ele).withTimeout(1),
      new WaitCommand(.5),
      new MoveL5(coral).alongWith(new OutCoral(coral)).withTimeout(15)
    );
  }
}
